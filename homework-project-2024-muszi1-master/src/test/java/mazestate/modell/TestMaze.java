...
public class TestMaze {
    public static Square[][] TEST_MAZE = {
        {
...

        {
            new Square(new Position(1, 0), new Wall[]{Wall.LEFT}, false, false),
                    ...
                    new Square(new Position(1, 4), new Wall[]{}, false, false),
                    new Square(new Position(1, 5), new Wall[]{}, false, false),
                    new Square(new Position(1, 6), new Wall[]{Wall.TOP,Wall.RIGHT}, true, false)},
...

        {
            new Square(new Position(5, 0), new Wall[]{Wall.TOP,Wall.LEFT}, false, false),
                    ...
                    new Square(new Position(5, 2), new Wall[]{Wall.RIGHT, Wall.LEFT,Wall.BOTTOM}, false, false),
...

        {
            new Square(new Position(6, 0), new Wall[]{Wall.LEFT,Wall.BOTTOM}, false, false),
                    ...
                    new Square(new Position(6, 6), new Wall[]{Wall.RIGHT,Wall.BOTTOM,Wall.LEFT}, false, true)}};
}
